public class DenMystiskaKronan
{
...
// Summerar utläggen
        ...
        expenses -= 2;  // här ska man inte addera, utan man ska subtrahera.
        System.out.println("Summan blir då: " + expenses);

// Kontrollerar att utläggen stämmer
        if (expenses != pastriesPrice)
            System.out.println("Error 404: Krona not found");
        else
            System.out.println(String.join("", "summan ar: ", Integer.toString(expenses)));
